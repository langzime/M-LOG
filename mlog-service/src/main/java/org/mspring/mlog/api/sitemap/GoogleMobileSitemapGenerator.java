 ...
 * To configure options, use {@link #builder(URL, File)}
 * 
 * @author Dan Fabulich
 * @see <a
 *      href="http://www.google.com/support/webmasters/bin/answer.py?answer=34648">Creating
 *      Mobile Sitemaps</a>
 */
public class GoogleMobileSitemapGenerator extends SitemapGenerator<GoogleMobileSitemapUrl, GoogleMobileSitemapGenerator> {
     ...
     */
    public GoogleMobileSitemapGenerator(String baseUrl, File baseDir) throws MalformedURLException {
    ...
    private static class Renderer extends AbstractSitemapUrlRenderer<GoogleMobileSitemapUrl> implements ISitemapUrlRenderer<GoogleMobileSitemapUrl> {
        ...
        public void render(GoogleMobileSitemapUrl url, OutputStreamWriter out, W3CDateFormat dateFormat) throws IOException {
