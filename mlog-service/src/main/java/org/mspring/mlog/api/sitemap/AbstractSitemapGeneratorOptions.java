...
abstract class AbstractSitemapGeneratorOptions<THIS extends AbstractSitemapGeneratorOptions<THIS>> {
    ...
    /**
     * The prefix of the name of the sitemaps we'll create; by default this is
     * "sitemap"
     */
    ...
    /**
     * When more than the maximum number of URLs are passed in, should we split
     * into multiple sitemaps automatically, or just throw an exception?
     */
    ...
    /**
     * Validate the sitemaps automatically after writing them; this takes time
     * (and may fail for Google-specific sitemaps)
     */
