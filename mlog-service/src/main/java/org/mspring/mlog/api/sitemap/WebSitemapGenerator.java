...
/**
 * Generates a regular old sitemap (USE THIS CLASS FIRST). To configure options,
 * use {@link #builder(URL, File)}
 * 
 * @author Dan Fabulich
 * 
 */
public class WebSitemapGenerator extends SitemapGenerator<WebSitemapUrl, WebSitemapGenerator> {
    ...
    public WebSitemapGenerator(String baseUrl, File baseDir) throws MalformedURLException {
