...
abstract class SitemapGenerator<U extends ISitemapUrl, THIS extends SitemapGenerator<U, THIS>> {
     ...
     * the maximum number of URLs, we'll throw an exception if
     * {@link #allowMultipleSitemaps} is false, or else write out one sitemap
     * immediately.
     * 
     * @param url
     ...
     * Add one URL of the appropriate type to this sitemap. If we have reached
     * the maximum number of URLs, we'll throw an exception if
     * {@link #allowMultipleSitemaps} is false, or write out one sitemap
     * immediately.
     * 
     * @param url
     *            the URL to add to this sitemap
     ...
     * necessary so we can keep an accurate count for
