...
public class SitemapValidator {
    ...
    // TODO support Mobile/Geo/Video/Code/News (sitemap.xsd doesn't support
    // them)
    ...
    // IMO news should have no non-news urls, geo should have no non-geo urls,
    // code should have no non-code urls
