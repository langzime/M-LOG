...
/**
 * Encapsulates a single URL to be inserted into a Web sitemap (as opposed to a
 * Geo sitemap, a Mobile sitemap, a Video sitemap, etc which are Google
 * specific). Specifying a lastMod, changeFreq, or priority is optional; you
 * specify those by using an Options object.
 * 
 * @see Options
 * @author Dan Fabulich
 * 
