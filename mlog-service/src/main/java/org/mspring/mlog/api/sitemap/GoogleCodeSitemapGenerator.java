...
/**
 * Builds a code sitemap for Google Code Search. To configure options, use
 * {@link #builder(URL, File)}
 * 
 * @author Dan Fabulich
 * @see <a
 *      href="http://www.google.com/support/webmasters/bin/answer.py?answer=75224">Creating
 *      Code Search Sitemaps</a>
 */
