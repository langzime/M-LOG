package org.mspring.mlog.api.sitemap;
...
public class SitemapIndexGenerator {
    ...
    public static class Options {
        ...
        /**
         * Configures the generator with a base URL and destination to write the
         * sitemap index file.
         * 
         * @param baseUrl
         *            All URLs in the generated sitemap(s) should appear under
         *            this base URL
         * @param outFile
         *            The sitemap index will be written out at this location
         */
         ...
         * {@link W3CDateFormat.Pattern} and/or a time zone
         */
        ...
        /**
         * The maximum number of sitemaps to allow per sitemap index; the
         * default is the maximum allowed (1,000), but you can decrease it if
         * you wish (for testing)
         */
        ...
        /**
         * Constructs a sitemap index generator configured with the options you
         * specified
         */
    ...
    /**
     * Add a numbered list of sitemaps to the index, e.g. "sitemap1.xml"
     * "sitemap2.xml" "sitemap3.xml" etc.
     * 
     * @param prefix
     *            the first part of the filename e.g. "sitemap"
     * @param suffix
     *            the last part of the filename e.g. ".xml" or ".xml.gz"
     * @param count
     *            the number of sitemaps (1-based)
     */
    ...
    public void write() {
        ...
        try {
            ...
            writeSiteMap(out);
            if (autoValidate)
                SitemapValidator.validateSitemapIndex(outFile);
        } catch (IOException e) {
