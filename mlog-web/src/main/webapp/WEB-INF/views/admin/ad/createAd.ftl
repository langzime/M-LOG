...
<form class="form" id="adForm" action="${base}/admin/ad/create/save" method="POST">
	<@spring.bind "ad" />
	<table class="formtable" style="width:100%">
		<tr>
			<td class="fieldlabel" style="width:60px;">编号:</td>
			<td>
				<@spring.formInput path="ad.id" attributes='class="textinput" style="width:98%;" disabled="disabled"' defaultValue="自动生成" />
			</td>
		</tr>
		<tr>
