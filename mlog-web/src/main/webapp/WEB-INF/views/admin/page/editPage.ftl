...
<form class="form" id="pageForm" action="${base}/admin/page/edit/save" method="POST">
	<@spring.bind "page" />
	<@spring.formHiddenInput path="page.createTime" />
	<table class="formtable" style="width:100%">
		<tr>
			<td class="fieldlabel" style="width:60px;">编号：</td>
			<td>
				<@spring.formInput path="page.id" attributes='class="textinput" style="width:98%;" readonly="readonly"' defaultValue="自动生成" />
			</td>
		</tr>
		<tr>
