	    ...
	    <div class="row-fluid">
	    	<form id="postForm" name="postForm" action="${base}/user/post/list" method="POST">
				...
				<div style="float:left;">
					<input type="button" class="btn btn-danger" value="删除草稿" id="btn_delete"/>
				</div>
    ...
    <script type="text/javascript">
    	$(function(){
    		$("#btn_delete").click(function(){
    			mlog.form.confirmSubmit('postForm', '${base}/user/post/delete_drafts', '确认要删除选中的草稿吗？');
    		});
    	});
    </script>
<#include "../footer.ftl" />